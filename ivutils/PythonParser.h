...
namespace ivutils
{
  ...
  class PythonParser
  {
    public:
      ...
      template<typename T> std::vector<T> getVector( const char* key ) const;
  ...
  template<> int PythonParser::get<int>( const char* key ) const;
  template<> bool PythonParser::get<bool>( const char* key ) const;
  template<> double PythonParser::get<double>( const char* key ) const;
  template<> std::string PythonParser::get<std::string>( const char* key ) const;
